...
export default function ServicesCTA() {
  ...
  return <section className="bg-black section-x section-y"><div ref={ref} className="relative mx-auto max-w-7xl overflow-hidden bg-[#00a896] rounded-2xl px-6 py-16 sm:px-10 md:px-20 md:py-24">
