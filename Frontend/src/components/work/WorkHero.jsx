...
export default function WorkHero() {
  ...
  return <section ref={sectionRef} data-hero-section onPointerMove={trackPointer} onPointerLeave={() => { pointerRef.current = { x: 0, y: 0 }; }} className="relative overflow-hidden bg-black section-x pb-20 pt-32 md:pb-28 md:pt-44">
