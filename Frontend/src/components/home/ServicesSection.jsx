        ...
        <FadeIn delay={0} y={40}>
          <div className="mb-14 md:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 md:pb-8 border-b border-white/10">
            <div>
              ...
              <h2 className="text-white font-syne font-extrabold uppercase tracking-tight leading-none mt-4 text-[clamp(2.5rem,10vw,9rem)]">
                SERVICES
              </h2>
            </div>
            <Link
              ...
              <FadeIn key={num} delay={i * 0.1} y={30}>
                <div className="group py-10 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-8 items-start hover:bg-white/[0.015] transition-colors duration-300 rounded-xl px-2 sm:px-4">
                  ...
                  <div className="md:col-span-4 lg:col-span-4">
                    <h3 className="text-white font-syne font-bold text-xl sm:text-3xl md:text-4xl uppercase group-hover:text-teal transition-colors duration-300">
                      {title}
                    </h3>
                  </div>

                  {/* Description & Action */}
                  <div className="md:col-span-6 lg:col-span-6 flex flex-col justify-between gap-5 sm:gap-6">
                    ...
                    >
                      ...
                      <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-teal/40 flex items-center justify-center text-teal group-hover:bg-teal group-hover:border-teal group-hover:text-black transition-all duration-300">
                        <ArrowRight size={15} />
                      </div>
                    </Link>
                  </div>
