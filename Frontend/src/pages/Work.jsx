...
const Work = () => {
  ...
  const projects = [
    ...
    { id: 5, name: 'Educore OS', category: 'portfolio', image: '/project6.png', tag: 'Learning platform',desc: 'A modern school management system that simplifies student administration, attendance, academics, fee tracking, and parent-teacher communication through an intuitive dashboard.' ,link: 'https://educore-liard.vercel.app/' },
    { id: 6, name: 'CoreCraft Portfolio', category: 'Portfolio', tag: 'Portfolio Website', desc: 'This very portfolio website showcasing our work and services with modern, elegant design.', image: 'https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=modern%20minimal%20dark%20theme%20portfolio%20website%20design%20with%20teal%20accent%20colors&image_size=landscape_16_9', isFeatured: false, link: '#' },
  ];
