...
const Work = () => {
  ...
  const projects = [
    ...
    { id: 5, name: 'Educore OS', category: 'School Management', image: '/project6.webp', w: 1909, h: 939, tag: 'Learning platform',desc: 'A modern school management system that simplifies student administration, attendance, academics, fee tracking, and parent-teacher communication through an intuitive dashboard.' ,link: 'https://educore-liard.vercel.app/', tags: ["React", "Node.js", "Express", "MySQL"] },
  ];
